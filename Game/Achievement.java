...
public class Achievement {
    ...
    public static void checkAndUpdateAchievements(UserDetails user) {
        ...
        if (!achievements.contains("Bookworm Beginner") && user.getRPlayed() >= 1) {
            achievements.add("Bookworm Beginner");
            JOptionPane.showMessageDialog(null, "Achievement Unlocked: Bookworm Beginner! You played 1 Reading games.");
        }
